...
+(void)addFriendNoticeWithUserId:(NSString *)userId
    ...
    BmobUser *toUser   = [BmobUser objectWithoutDataWithClassName:nil objectId:userId];
     NSLog(@"toUser---------------------%@",toUser);
    //添加到邀请信息表
...
+(void)agreeFriendWithObejctId:(NSString *)objectId userId:(NSString*)userId completion:(BmobBooleanResultBlock)block{
    ...
    BmobObject *obj = [BmobObject objectWithoutDataWithClassName:kInviteMessageTable objectId:objectId];
